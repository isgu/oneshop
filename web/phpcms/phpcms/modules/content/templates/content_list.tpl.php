...
<tbody>
	...
	?>
		...
		<td align='center'><?php if($_GET['catid']=='26'){ ?><a href="javascript:;" onclick="javascript:openwinx('?m=content&c=content&a=add_info&catid=<?php echo $catid;?>&id=<?php echo $r['id']?>','')">添加说明</a> |<?php }?> <a href="javascript:;" onclick="javascript:openwinx('?m=content&c=content&a=edit&catid=<?php echo $catid;?>&id=<?php echo $r['id']?>','')"><?php echo L('edit');?></a> | <a href="javascript:view_comment('<?php echo id_encode('content_'.$catid,$r['id'],$this->siteid);?>','<?php echo safe_replace($r['title']);?>')"><?php echo L('comment');?></a></td>
