...
<div class="table-responsive">
	<table class="table table-hover table-striped mt10">
		<tr>
			...
			<th><?php echo $model->getAttributeLabel('is_alias')?></th>
			<th><?php echo $model->getAttributeLabel('is_color')?></th>
			<th><?php echo $model->getAttributeLabel('is_enu')?></th>
			<th><?php echo $model->getAttributeLabel('is_input')?></th>
			<th><?php echo $model->getAttributeLabel('is_crux')?></th>
			<th><?php echo $model->getAttributeLabel('is_sale')?></th>
			<th><?php echo $model->getAttributeLabel('is_search')?></th>
			<th><?php echo $model->getAttributeLabel('is_must')?></th>
			<th><?php echo $model->getAttributeLabel('is_choose')?></th>
		...
		<tr>
			...
			<td><?php echo CHtml::encode($item->is_alias); ?></td>
			<td><?php echo CHtml::encode($item->is_color); ?></td>
			<td><?php echo CHtml::encode($item->is_enu); ?></td>
			<td><?php echo CHtml::encode($item->is_input); ?></td>
			<td><?php echo CHtml::encode($item->is_crux); ?></td>
			<td><?php echo CHtml::encode($item->is_sale); ?></td>
			<td><?php echo CHtml::encode($item->is_search); ?></td>
			<td><?php echo CHtml::encode($item->is_must); ?></td>
			<td><?php echo CHtml::encode($item->is_choose); ?></td>
