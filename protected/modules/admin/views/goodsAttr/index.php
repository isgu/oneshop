...
<div class="table-responsive">
	<table class="table table-hover table-striped mt10">
		<tr>
			...
			<th><?php echo $model->getAttributeLabel('attr_id')?></th>
			<th><?php echo $model->getAttributeLabel('attr_value_id')?></th>
			<th><?php echo $model->getAttributeLabel('is_sku')?></th>
			<th><?php echo $model->getAttributeLabel('sku_id')?></th>
		...
		<tr>
			...
			<td><?php echo CHtml::encode($item->attr_id); ?></td>
			<td><?php echo CHtml::encode($item->attr_value_id); ?></td>
			<td><?php echo CHtml::encode($item->is_sku); ?></td>
			<td><?php echo CHtml::encode($item->sku_id); ?></td>
