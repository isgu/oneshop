...
class GoodsImageController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['GoodsImage'];
			if($model->save())
	...
	public function actionDelete()
	{
		...
		$models = GoodsImage::model()->findAllByPk($ids);
	...
	{
		$model=new GoodsImage('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['GoodsImage']))
			$model->attributes=$_GET['GoodsImage'];
	...
	{
		$model=GoodsImage::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param GoodsImage $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='goods-image-form')
		{
