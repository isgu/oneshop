...
class AttributeValue extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('attribute_id, status, sort, category_id, creation_time', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, attribute_id, status, sort, category_id, creation_time', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'goodsAttrs' => array(self::HAS_MANY, 'GoodsAttr', 'attr_id'),
		);
	}
